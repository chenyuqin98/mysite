...
option.add_argument('--headless')  # 使用无头谷歌浏览器模式
option.add_argument('--disable-gpu')
option.add_argument('--no-sandbox')
# 无效伪装

browser = webdriver.Chrome(executable_path="C:/Users/Administrator/AppData/Local/Google/Chrome/Application/chromedriver.exe",options=option)  #路径是chromedriver.exe的存放的位置
